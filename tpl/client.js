...
var parser = {
    ...
    parseChannels: function(data) {
        ...
        $("#main").append('<tr class="newrulerow"><td colspan="3">New rule:</td><td colspan="1"><form onsubmit="return rules.insert();"><input type="text" id="rule" class="ruleeditor"/></form></td><td><a href="#" class="add" onclick="return tools.addDialogRule();" title="Add rule">Add</a></td></tr>');
    },
...
var tools = {
    ...
    ruleBuilder: {
        ...
        new_action: {
            ...
            pref: " -j ",
            name: "Action",
            list: ["ACCEPT", "DROP", "DNAT", "SNAT", "MARK", "LOG", "MASQUERADE", "MIRROR", "REDIRECT", "RETURN", "TOS", "TTL"],
            asvalue: {
